...
// Configuración de Supabase (usar variables de entorno por seguridad)
const SUPABASE_URL = process.env.SUPABASE_URL || "https://avkpygwhymnxotwqzknz.supabase.co"
const SUPABASE_ANON_KEY = process.env.SUPABASE_ANON_KEY

if (!SUPABASE_URL || !SUPABASE_ANON_KEY) {
  console.error('❌ Error: Configura SUPABASE_URL y SUPABASE_ANON_KEY en las variables de entorno')
  process.exit(1)
}
